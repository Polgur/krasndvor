...
class ProjectFilterForm(forms.Form):
    ...
    tech = forms.ModelChoiceField(queryset=Techno.objects.filter(main=True), label='Технология', empty_label=None,
                                  required=False)
...
class MainCalc(BaseCalcForm):
    class Meta:
        ...
        widgets = {
            'fio': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваше имя', 'class': 'col-md-12 form-control'}),
            'email': forms.EmailInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш email адрес', 'class': 'col-md-12 form-control'}),
            'phone': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш номер телефона', 'class': 'col-md-12 form-control'}),
    ...
    class Meta:
        ...
        widgets = {
            ...
            'phone': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш номер телефона', 'class': 'col-md-12 form-control'}),
            'note': forms.Textarea(
                attrs={'placeholder': 'Нужна реконструкция дома', 'class': 'col-md-12 form-control'}),
            'file': forms.FileInput(attrs={'class': 'col-md-12 form-control'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'phone': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш номер телефона', 'class': 'col-md-12 form-control'}),
            'note': forms.Textarea(
                attrs={'placeholder': 'Нужен фундамент для дома', 'class': 'col-md-12 form-control'}),
            'file': forms.FileInput(attrs={'class': 'col-md-12 form-control'}),
        }


class RemontCalc(BaseCalcForm):
    class Meta:
        model = Calculation
        exclude = (
            'created',
        ...
        widgets = {
            ...
            'phone': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш номер телефона', 'class': 'col-md-12 form-control'}),
            'note': forms.Textarea(
                attrs={'placeholder': 'Нужен ремонт', 'class': 'col-md-12 form-control'}),
            'file': forms.FileInput(attrs={'class': 'col-md-12 form-control'}),
        }
...
class PhoneForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'phone': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите Ваш номер телефона', 'class': 'col-md-12 form-control'}),
            'wtime': forms.TextInput(
                attrs={'placeholder': 'Пожалуйста, введите желаемое время звонка', 'class': 'col-md-12 form-control'}),
        }
